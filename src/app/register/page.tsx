...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Simulación (reemplazar con fetch real en Next.js)
    setTimeout(() => {
      setSuccess(true);
      setLoading(false);
    }, 1500);
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#120F17] flex items-center justify-center px-4">
        <div
  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center px-4 py-12" style={{ background: '#120F17' }}>
      ...
      >
        ...
        <div className="relative z-10 rounded-3xl bg-[#0f0f23] p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onFocus={(e) => { e.currentTarget.style.border = "1px solid rgba(236,72,153,0.8)"; e.currentTarget.style.boxShadow = "0 0 20px rgba(236,72,153,0.2)"; e.currentTarget.style.background = "rgba(236,72,153,0.06)"; }}
                  onBlur={(e) => { e.currentTarget.style.border = "1px solid rgba(255,255,255,0.1)"; e.currentTarget.style.boxShadow = "none"; e.currentTarget.style.background = "rgba(255,255,255,0.05)"; }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg">🏠</span>
                <input
                  type="text" required value={domicilio}
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg">📮</span>
                <input
                  type="text" required value={codigoPostal}
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg">📱</span>
                <input
                  type="tel" required value={telefono}
            ...
            {error && (
              <div className="rounded-xl px-4 py-3 text-sm"
                style={{ background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.3)", color: "#fca5a5", animation: "shake 0.4s ease" }}>
                ⚠️ {error}
              </div>
            )}
            ...
            <button type="submit" disabled={loading}
              ...
              style={{ background: "linear-gradient(135deg, #ec4899, #7c3aed)", boxShadow: "0 0 30px rgba(236,72,153,0.4)" }}
              onMouseEnter={(e) => { if (!loading) { e.currentTarget.style.boxShadow = "0 0 50px rgba(236,72,153,0.7)"; e.currentTarget.style.transform = "translateY(-2px)"; } }}
              onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "0 0 30px rgba(236,72,153,0.4)"; e.currentTarget.style.transform = "translateY(0)"; }}
            >
              {loading ? (
                <span className="flex items-center justify-center gap-2">
                  <span className="w-5 h-5 rounded-full border-2 border-white border-t-transparent" style={{ animation: "spin 0.8s linear infinite" }} />
                  Creando cuenta...
                </span>
              ) : "Crear cuenta →"}
            </button>
          ...
          <p className="text-center text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
            ¿Ya tienes cuenta?{" "}
            <a href="/login" className="font-semibold transition-all duration-200" style={{ color: "#f472b6" }}
              onMouseEnter={(e) => { e.currentTarget.style.color = "#ec4899"; e.currentTarget.style.textShadow = "0 0 10px rgba(236,72,153,0.5)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = "#f472b6"; e.currentTarget.style.textShadow = "none"; }}
            >
              Inicia sesión
            </a>
          </p>
